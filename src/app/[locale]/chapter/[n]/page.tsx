...
export default async function ChapterPage({ params }: { params: Params }) {
  ...
  const [chapter, verses] = await Promise.all([getChapter(number), getVersesInChapter(number)]);
        ...
        <Container size="md">
          ...
          <div className="mt-10 grid md:grid-cols-[auto_1fr] gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-text-muted leading-relaxed line-clamp-6">{chapter.summary}</p>
